            ...
            <div className="settingpage">
                ...
                <div className="profilesettings">
                    <div className="leftprofile_details flex">
                        <img src="/img/adminDP.png" alt="adminDP" data-aos="fade-left" />
                        <div className="w-100" data-aos="fade-up">
                            <div className='flex flex-sb flex-left mt-2'>
                                <h2>My Profile:</h2>
                                <h3>Oracle EBS Technofunctional <br /> ERP SCM Consultant</h3>
                            </div>
                            <div className="flex flex-sb mt-2">
                                <h3>Phone:</h3>
                                <input type="text" defaultValue="+1-563-299-8622" />
                            </div>
                            <div className="mt-2">
                                <input type="email" defaultValue="dhirajvpathak@gmail.com" />
                            </div>
