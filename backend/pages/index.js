            ...
            <div className="right_salescont">
              ...
              <div className="blogscategory flex flex-center">
                <table data-aos="fade-up">
                  ...
                  <tbody>
                    <tr>
                      <td>Oracle EBS R12 Functional</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "OracleEBSFunctional").length}</td>
                    </tr>
                    <tr>
                      <td>Oracle EBS R12 Technical</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "OracleEBSTechnical").length}</td>
                    </tr>
                    <tr>
                      <td>Oracle Fusion Functional</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "OracleFusionFunctional").length}</td>
                    </tr>
                    <tr>
                      <td>Oracle EBS R12 Technical</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "OracleFusionTechnical").length}</td>
                    </tr>
                    <tr>
                      <td>Machine Learning</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "MachineLearning").length}</td>
                    </tr>
                    <tr>
                      <td>Artificial Intelligence</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "ArtificialIntelligence").length}</td>
                    </tr>
                    <tr>
                      <td>Tools For Testing</td>
                      <td>{blogsData.filter(dat => dat.blogcategory[0] === "ToolsForTesting").length}</td>
                    </tr>                    
                    <tr>
