        ...
        <form onSubmit={createProduct} className='addWebsiteform'>
            ...
            <div className='w-100 flex flex-col flex-left mb-2' data-aos="fade-up">
                ...
                <select onChange={(e) => setBlogcategory(Array.from(e.target.selectedOptions, option => option.value))} name="catergory" id="catergory" multiple value={blogcategory} >
                    <option value="OracleEBSFunctional"> Oracle EBS R12 Functional</option>
                    <option value="OracleEBSTechnical"> Oracle EBS R12 Technical</option>
                    <option value="OracleFusionFunctional"> Oracle Fusion Functional</option>
                    <option value="OracleFusionTechnical"> Oracle Fusion Technical</option>
                    <option value="MachineLearning"> Machine Learning</option>
                    <option value="ArtificialIntelligence"> Artificial Intelligence</option>
                    <option value="ToolsForTesting"> Tools For Testing</option>
            ...
            <div className='w-100 flex flex-col flex-left mb-2' data-aos="fade-up">
                ...
                <select onChange={(e) => setTags(Array.from(e.target.selectedOptions, option => option.value))} name="tags" id="tags" multiple value={tags}>
                    <option value="EBS Functional">EBS Functional</option>
                    <option value="EBS Technical">EBS Technical</option>
                    <option value="Fusion Functional">Fusion Functional</option>
                    <option value="Fusion Technical">Fusion Technical</option>
